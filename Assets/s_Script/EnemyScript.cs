...
public class EnemyScript : MonoBehaviour
{
    ...
    private EnemyStatus enemyVal;

    public EnemyStatus EnemyStatusReturn()
    {
        enemyVal = (useDefault) ? enemySetting.enemyStatus : enemyStatus;
        return enemyVal;
    }
    void Start()
    {
        health = EnemyStatusReturn().health;
    }
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        if (collider.gameObject.CompareTag("skillattack"))
        {
            Damage(2);
